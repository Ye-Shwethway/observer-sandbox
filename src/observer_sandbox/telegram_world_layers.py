...
from .telegram_world_layers_location_cleanup_extension import install_location_cleanup_world_layers_extension
...
install_location_cleanup_world_layers_extension(_base)
