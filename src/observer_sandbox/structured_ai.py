...
def generate_structured(
    ...
    *,
    ...
    activation remains an explicit later binding operation. Callers with materially
    larger structured responses may opt into a bounded longer transport timeout.
    """
    model = conn.execute(
