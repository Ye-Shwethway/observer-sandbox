...
ACTION_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {"action_type": "inspect", "label": "Inspect", "min": 1, "max": 10, "target_mode": "object", "capability": "inspect", "colocation": 1},
    {"action_type": "use", "label": "Use", "min": 1, "max": 60, "target_mode": "object", "capability": "use", "colocation": 1},
