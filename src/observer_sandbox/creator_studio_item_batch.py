...
def ai_item_batch_draft(
    ...
    *,
    ...
    prompt = (
        ...
        "Do not omit, rename or invent schema fields. Preserve requested stack quantities. For requested batch-local storage, use stored_in='$ref' and make the target a real container Item. "
